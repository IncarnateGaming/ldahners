class IncarnatePolicyAccept{
    static makeBanner(){
        ...
        banner.setAttribute('class','incarnate-policy-banner inc-flex-orientation');
        banner.innerHTML = `
            <p class="px-1">We use cookies to ensure that we give you the best experience on our website. If you continue to use this site we will assume that you are happy with it.</p>
            <div class="d-flex flex-row">
                <button class="accept btn btn-primary pb-1 m-1 inc-flex-grow">Ok</button>
                <button class="reject btn btn-primary pb-1 m-1 inc-flex-grow">No</button>
            </div>
            <button class="policy btn btn-primary pb-1 m-1">Privacy Policy</button>
        `;
